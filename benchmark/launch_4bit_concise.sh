#!/usr/bin/env bash
# Launch NVMAIServer for 4-bit model with concise mode ON, prompt cache ON, MTP OFF.
set -euo pipefail
...
MODEL="$BASE_DIR/models/qwen3.6_35B_A3B_4Bit"
PORT=8081
...
if [[ ! -d "$MODEL" ]]; then
  echo "ERROR: 4-bit model not found at $MODEL" >&2
  exit 1
fi

echo "============================================================"
echo " NVMAIServer — 4-bit + concise + cache ON + MTP OFF"
echo "============================================================"
echo " Port:      $PORT"
echo " Model:     $MODEL"
echo " Concise:   on (standard 4-bit prompt)"
echo "============================================================"
echo ""
